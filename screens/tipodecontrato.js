...
export default function TipodeContrato() {
    ...
    return (
        <View>
            <MenuRetornar options={[{ title: 'Cadastro do Tipo de Contrato', voltar: 'TelaInicial' }]} />
            <View style={styles.container}>

                <View style={styles.containerdentro}>
                    <Text style={styles.texto}>
                        Descrição do Tipo de de Contrato
                    </Text>
                    <TextInput style={styles.caixadetexto} onChangeText={setTipoContrato}>
                    </TextInput>
                </View>
                ...
                <View style={styles.containerdentro}>
                    ...
                    <TextInput style={styles.caixadetexto} onChangeText={setValorMes}>
                    </TextInput>
                </View>
